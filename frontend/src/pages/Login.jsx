  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: 'radial-gradient(circle, rgba(255,107,138,0.06) 0%, transparent 65%)',
        pointerEvents: 'none', borderRadius: '50%'
      }} />
      ...
      <div className="fade-in" style={{
        ...
        <h1 style={{ fontSize: '1.75rem', fontWeight: 800, marginBottom: 6, letterSpacing: '-0.02em' }}>Welcome back</h1>
        <p style={{ color: 'var(--text2)', marginBottom: 32, fontSize: '0.9rem' }}>Sign in to continue to your workspace</p>
        ...
        <form onSubmit={handle} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
          ...
          <button id="login-submit" type="submit" className="btn-primary" disabled={loading} style={{
            padding: '13px', justifyContent: 'center', fontSize: '0.95rem', marginTop: 4,
            width: '100%'
          }}>
